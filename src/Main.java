...
@@ -43,9 +40,7 @@ public static void main(String[] args) {
        ...
        devJoao.setNome("Carlos");
        devJoao.inscreverBootcamp(bootcamp);
        System.out.println("Conteúdos Inscritos João:" + devJoao.getConteudosInscritos());
        System.out.println("Conteúdos Inscritos Carlos:" + devJoao.getConteudosInscritos());
        devJoao.progredir();
        devJoao.progredir();
        devJoao.progredir();
        System.out.println("-");
        ...
        System.out.println("Conteúdos Inscritos Carlos:" + devJoao.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos Carlos:" + devJoao.getConteudosConcluidos());
